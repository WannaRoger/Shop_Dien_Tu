            ...
            <div class="col-12">
                <div class="card my-4">
                    ...
                    <div class="row m-3 border border-danger border-dashed">
                        ...
                        <div class="row mx-3 ">
                            <span><span class="font-weight-bold">Tên khách hàng:</span> Nguyễn Hữu Kiệt</span>
                            <span><span class="font-weight-bold">Số điện thoại:</span> 03242585307</span>
                            <span><span class="font-weight-bold">Địa chỉ:</span> Duy Tiên, Hà Nam</span>
                        </div>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="{{ url('admin/san-pham/chi-tiet') }}" class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ asset('uploads/team-2.jpg') }} "
